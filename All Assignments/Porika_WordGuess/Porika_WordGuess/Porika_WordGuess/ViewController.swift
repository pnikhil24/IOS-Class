...
//  Porika_WordGuess
//
//  Created by Nikhil Porika on 3/30/22.
//
...
class ViewController: UIViewController {
    ...
    var words = [["APPLE", "Famous Mobile Brand in US"],
                 ["COVID","Virus effected most people"],
                 ["GOA", "Famous Tourist State in India"],
                 ["BIRYANI", "Famous Food item of Hyderabad"],
                 ["WALMART", "Famous Grocery Store in USA"]]

    var images =  ["apple","covid","goa","biryani","walmart","NeverGiveUp"]
